...
# this won't be run when imported
    ...
    print('(Cross validation) Average f1-weighted score: %.4f%%(+/- %.4f%%)' % (mean_score*100,std_score*100))
    ...
    print("(Test) F1-weighted score: %.4f%%"+str(test_score*100))


    ############################################################################
    
    ## Create kaggle sumbition on their test data
